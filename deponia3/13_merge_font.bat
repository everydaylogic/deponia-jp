...
%relocate_font_png_cmd% --overwrap  %orig_dir%\02577.system_standard.png  %orig_dir%\02577.txt -a %in_dir%\system_standard.png %in_dir%\system_standard.txt %out_dir%\02577.system_standard.png  %out_dir%\02577.txt --size 3072 2250 --sort --charset %charset_orig_standard%    --charset %charset_ja%

for %%a in ( %out_dir%\02577.*.png ) do (
